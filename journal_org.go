...
func FormatTradeOrg(t TradeRecord) string {
	...
	writeOrgProperty(&b, "ENTRY_PRICE", formatScaledPrice(t.EntryPrice, int32(PriceScale)))
	writeOrgProperty(&b, "EXIT_PRICE", formatScaledPrice(t.ExitPrice, int32(PriceScale)))
