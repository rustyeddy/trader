...
func (f jsonFormatter) FormatAccounts(w io.Writer, resp svcbroker.AccountsResponse) error {
...
func (f jsonFormatter) FormatSnapshot(w io.Writer, resp svcbroker.SnapshotResponse) error {
...
func (f jsonFormatter) FormatSubmit(w io.Writer, resp svcbroker.SubmitResponse) error {
	o := resp.Order
