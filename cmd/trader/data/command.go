...
// New returns the "data" command group: the shell M2.5's
...
// (service.go). This relies on cobra.EnableTraverseRunHooks (set
// once in rootcmd.New): without it, Cobra would run only the *closest*
