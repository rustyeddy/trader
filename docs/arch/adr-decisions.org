...
| 020 | Historic data subsystem (in adr-020-historic-data.org)            | Proposed   |
...
consult it for the full decisions and open questions.  As of this
writing, ADR-020 remains =Proposed=: nearly every open question it
raised has been settled (issues #70-#81), but issue #99 (H4 alignment
disagreeing with ADR-012, discovered during #81's corpus validation) is
an explicit blocker to promoting it to =Accepted=.
