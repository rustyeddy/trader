...
// supplied by Manager's own build step (normalizeAndPublish, build.go,
// #81) that reads raw provider bytes; Manifest itself has no provider or
// storage dependency and never reaches into a package such as
