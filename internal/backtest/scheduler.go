...
type InputBuilder interface {
	Build(ctx context.Context, intent runtimeorder.Intent, event strategy.BarEvent, snapshot account.Snapshot) (pipeline.Input, error)
}
...
type Scheduler struct {
	...
	// keyed the same way.
	queued map[requirementKey][]runtimeorder.Intent
...
func (s *Scheduler) submit(ctx context.Context, intent runtimeorder.Intent, event strategy.BarEvent) error {
...
//     own safety contract.
func (s *Scheduler) submitBracketOutcome(ctx context.Context, bracketIntent runtimeorder.Intent, corr id.CorrelationID, bracket *pipeline.BracketOutcome, submitErr error) error {
...
func (s *Scheduler) journalBracketLeg(ctx context.Context, corr id.CorrelationID, legIntent runtimeorder.Intent, leg pipeline.Result) error {
