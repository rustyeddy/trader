...
func (m *Metrics) computeTradeStats(trades []runtimeorder.Trade, currency num.Currency) error {
...
func perInstrumentMetrics(trades []runtimeorder.Trade, currency num.Currency) ([]InstrumentMetrics, error) {
	zero := zeroMoneyMust(currency)
...
func sideMetrics(trades []runtimeorder.Trade, currency num.Currency) ([]SideMetrics, error) {
	zero := zeroMoneyMust(currency)
