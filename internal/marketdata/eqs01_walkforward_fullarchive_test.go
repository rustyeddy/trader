...
func setupEQS01WalkForwardInstrument(t *testing.T, ctx context.Context, inst eqs01WFInstrument) eqs01WFSetup {
	...
	query := marketruntime.BarQuery{Instrument: instID, Interval: marketdata.D1, Range: span}
...
func runEQS01WFBacktest(ctx context.Context, mgr *marketruntime.Manager, simResolver instrument.Resolver, simID instrument.ID,
