...
func (m *Manager) publishCanonicalMonth(ctx context.Context, symbol string, interval marketdata.Interval, year int, month time.Month, manifest marketdata.Manifest, bs marketdata.BarSet) error {
	key := partitionKey{
