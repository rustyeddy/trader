...
type Account interface {
	...
	Submit(ctx context.Context, req runtimeorder.Request) (runtimeorder.Order, error)
	...
	// not be opened.
	Cancel(ctx context.Context, req runtimeorder.CancelRequest) (runtimeorder.CancelResult, error)
	...
	Replace(ctx context.Context, req runtimeorder.ReplaceRequest) (runtimeorder.ReplaceResult, error)
