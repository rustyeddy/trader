...
const brokerImportPath = "github.com/rustyeddy/trader/internal/broker"
...
// forbidden.
var domainPackagesThatMustNotImportBroker = []string{"internal/account", "internal/order", "order"}
