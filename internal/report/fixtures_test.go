...
func fixtureTrade(t *testing.T, ids *id.Generator, accountID id.AccountID, listing instrument.Listing, side order.PositionSide, realizedPnL, costs string, openedAt, closedAt time.Time) runtimeorder.Trade {
	t.Helper()
...
func fixtureOpenTrade(t *testing.T, ids *id.Generator, accountID id.AccountID, listing instrument.Listing, side order.PositionSide, costs string, openedAt time.Time) runtimeorder.Trade {
	t.Helper()
	tr, err := runtimeorder.NewTrade(runtimeorder.Trade{
		AccountID:    accountID,
		Listing:      listing,
