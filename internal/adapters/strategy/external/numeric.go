...
// own "Common value types" section) into num.Price/num.Quantity —
// never through a float64, matching num's own ParsePrice/ParseQuantity
// checked-decimal-text contract and ADR-004.

// parsePrice parses a required price field. An empty string is
// rejected; priceOrEmpty (below) is this function's own toWire
// counterpart for a field the wire schema documents as "empty means
// not applicable".
