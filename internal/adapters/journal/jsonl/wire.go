...
func toIntentWire(in runtimeorder.Intent) intentWire {
	return intentWire{
...
func toProposalWire(p runtimeorder.Proposal) proposalWire {
	return proposalWire{
...
func toRequestWire(r runtimeorder.Request) requestWire {
...
func toReplaceRequestWire(r runtimeorder.ReplaceRequest) replaceRequestWire {
...
func toOrderWire(o runtimeorder.Order) orderWire {
	w := orderWire{
...
func toFillWire(f runtimeorder.Fill) fillWire {
	return fillWire{
		FillID:        f.FillID,
		OrderID:       f.OrderID,
...
func toPositionWire(p runtimeorder.Position) positionWire {
...
func toTradeWire(t runtimeorder.Trade) tradeWire {
	return tradeWire{
