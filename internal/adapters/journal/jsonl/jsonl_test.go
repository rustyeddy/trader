...
func intentPtr(v runtimeorder.Intent) *runtimeorder.Intent       { return &v }
func proposalPtr(v runtimeorder.Proposal) *runtimeorder.Proposal { return &v }
...
func requestPtr(v runtimeorder.Request) *runtimeorder.Request                      { return &v }
func replaceRequestPtr(v runtimeorder.ReplaceRequest) *runtimeorder.ReplaceRequest { return &v }
func orderPtr(v runtimeorder.Order) *runtimeorder.Order                            { return &v }
func fillPtr(v runtimeorder.Fill) *runtimeorder.Fill                               { return &v }
func accountPtr(v account.Snapshot) *account.Snapshot                              { return &v }
func statusPtr(v broker.Status) *broker.Status                                     { return &v }
func tradePtr(v runtimeorder.Trade) *runtimeorder.Trade                            { return &v }
