...
// unnoticed).
func checkReplaceInput(in ReplaceInput) (runtimeorder.Intent, error) {
	intent, err := runtimeorder.NewIntent(in.Intent)
	if err != nil {
...
func (p *planner) PlanReplace(ctx context.Context, in ReplaceInput) (ReplaceResult, error) {
	...
	req, err := runtimeorder.NewReplaceRequest(runtimeorder.ReplaceRequest{
