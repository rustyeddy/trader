...
func TestPlanReplace_RatchetsExistingStop(t *testing.T) {
	...
	snap := mustSnapshotWithOpenOrders(t, accountID, listing, []runtimeorder.Position{pos}, []runtimeorder.Order{existing})
...
func TestPlanReplace_IgnoresNonReduceOnlyStopOrder(t *testing.T) {
	...
	snap := mustSnapshotWithOpenOrders(t, accountID, listing, []runtimeorder.Position{pos}, []runtimeorder.Order{notReduceOnly})
	intent := mustAdjustStopIntent(t, deps.IDs, listing.InstrumentID())
...
func TestPlanReplace_IgnoresWrongSideStopOrder(t *testing.T) {
	...
	snap := mustSnapshotWithOpenOrders(t, accountID, listing, []runtimeorder.Position{pos}, []runtimeorder.Order{wrongSide})
	intent := mustAdjustStopIntent(t, deps.IDs, listing.InstrumentID())
