...
func AssertStatus(t assert.TestingT, want runtimeorder.Status, o runtimeorder.Order, msgAndArgs ...any) bool {
	helper(t)
	if o.Status == want {
		return true
	}
...
// or StatusExpired.
func AssertTerminal(t assert.TestingT, o runtimeorder.Order, msgAndArgs ...any) bool {
	helper(t)
