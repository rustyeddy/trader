...
func TestServiceHasNoTransportDependencies(t *testing.T) {
	...
	// github.com/rustyeddy/trader/internal/service/... rather than a relative
	...
	const pattern = "github.com/rustyeddy/trader/internal/service/..."
	...
	for _, line := range lines {
		...
		require.True(t, strings.HasPrefix(pkg, "github.com/rustyeddy/trader/internal/service"),
