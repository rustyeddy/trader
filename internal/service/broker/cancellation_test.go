...
func (a *ctxCheckingAccount) Submit(ctx context.Context, req runtimeorder.Request) (runtimeorder.Order, error) {
	if err := ctx.Err(); err != nil {
		return runtimeorder.Order{}, err
	}
	return runtimeorder.Order{}, nil
}

func (a *ctxCheckingAccount) Cancel(ctx context.Context, req runtimeorder.CancelRequest) (runtimeorder.CancelResult, error) {
	if err := ctx.Err(); err != nil {
		return runtimeorder.CancelResult{}, err
	}
	return runtimeorder.CancelResult{}, nil
}

func (a *ctxCheckingAccount) Replace(ctx context.Context, req runtimeorder.ReplaceRequest) (runtimeorder.ReplaceResult, error) {
	if err := ctx.Err(); err != nil {
		return runtimeorder.ReplaceResult{}, err
	}
	return runtimeorder.ReplaceResult{}, nil
}
...
func TestServiceSubmitPropagatesContextCancellation(t *testing.T) {
	...
	req := runtimeorder.Request{Proposal: runtimeorder.Proposal{AccountID: accountID}}
