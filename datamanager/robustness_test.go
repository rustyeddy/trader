...
func TestBuildHourM1_MultipleTicksSameMinute(t *testing.T) {
	...
	ticks := []RawTick{
		{TimeMillis: baseMS + 100, Ask: 13010, Bid: 13000}, // open
		{TimeMillis: baseMS + 200, Ask: 13025, Bid: 13015}, // higher → high
		{TimeMillis: baseMS + 300, Ask: 13005, Bid: 12995}, // lower  → low
		{TimeMillis: baseMS + 400, Ask: 13012, Bid: 13002}, // close
	}
