// Package strategysdk is the guest-side counterpart to
...
//	}
//
// strategysdk is a top-level, public, non-domain framework package —
...
//
// strategysdk.Strategy mirrors strategy.Strategy's shape (Describe,
// Start, OnBar, plus a strategysdk.FillHandler equivalent of
...
//
// strategysdk depends on protocol/strategy/v1 and on order,
...
// strategysdk never calls. It never imports strategy, and never
...
// does. strategysdk and adapters/strategy/external both depend on
...
// the other" reason above. This is the one place strategysdk reads
