...
func TestNewChandelierExit_Valid(t *testing.T) {
	...
	c, err := NewChandelierExit(3, 2.0, types.PriceScale)
...
func TestNewChandelierExit_ZeroPeriod(t *testing.T) {
	...
	_, err := NewChandelierExit(0, 2.0, types.PriceScale)
	require.Error(t, err)
...
func TestNewChandelierExit_NegativePeriod(t *testing.T) {
	...
	_, err := NewChandelierExit(-1, 2.0, types.PriceScale)
	require.Error(t, err)
}
...
func TestChandelierExit_Name(t *testing.T) {
	...
	c, err := NewChandelierExit(3, 2.5, types.PriceScale)
	require.NoError(t, err)
...
func TestChandelierExit_NotReadyBeforeWarmup(t *testing.T) {
	...
	c, err := NewChandelierExit(2, 2.0, types.PriceScale)
	require.NoError(t, err)
...
func TestChandelierExit_InitialStop_NotReady(t *testing.T) {
	...
	stop := c.InitialStop(types.Long, 100, market.Candle{})
	require.Equal(t, types.Price(0), stop)

	stop = c.InitialStop(types.Short, 100, market.Candle{})
	require.Equal(t, types.Price(0), stop)
}
...
func TestChandelierExit_InitialStop_Long(t *testing.T) {
	...
	stop := c.InitialStop(types.Long, 100, market.Candle{})
	require.Equal(t, types.Price(60), stop)
}
...
func TestChandelierExit_InitialStop_Short(t *testing.T) {
	...
	stop := c.InitialStop(types.Short, 100, market.Candle{})
	require.Equal(t, types.Price(140), stop)
}
...
func TestChandelierExit_InitialStop_LongUnderflow(t *testing.T) {
	...
	c, err := NewChandelierExit(2, 10.0, types.PriceScale)
	require.NoError(t, err)
	warmUpChandelier(c, 2)

	stop := c.InitialStop(types.Long, 10, market.Candle{})
	require.Equal(t, types.Price(0), stop)
}
...
func TestChandelierExit_UpdateStop_NotReady(t *testing.T) {
	...
	stop := c.UpdateStop(types.Long, 55, 0, 110, market.Candle{})
	require.Equal(t, types.Price(55), stop)
}
...
func TestChandelierExit_UpdateStop_Long_Advances(t *testing.T) {
	...
	stop := c.UpdateStop(types.Long, 60, 0, 150, market.Candle{})
	require.Equal(t, types.Price(110), stop)
}
...
func TestChandelierExit_UpdateStop_Long_Holds(t *testing.T) {
	...
	stop := c.UpdateStop(types.Long, 60, 0, 90, market.Candle{})
	require.Equal(t, types.Price(60), stop)
}
...
func TestChandelierExit_UpdateStop_Short_InitialSet(t *testing.T) {
	...
	stop := c.UpdateStop(types.Short, 0, 0, 80, market.Candle{})
	require.Equal(t, types.Price(120), stop)
}
...
func TestChandelierExit_UpdateStop_Short_Tightens(t *testing.T) {
	...
	stop := c.UpdateStop(types.Short, 120, 0, 70, market.Candle{})
	require.Equal(t, types.Price(110), stop)
}
...
func TestChandelierExit_UpdateStop_Short_Holds(t *testing.T) {
	...
	stop := c.UpdateStop(types.Short, 120, 0, 90, market.Candle{})
	require.Equal(t, types.Price(120), stop)
}
