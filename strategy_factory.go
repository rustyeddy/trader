...
// NewStrategyFromResolvedRun creates a Strategy for a resolved backtest run.
func NewStrategyFromResolvedRun(r ResolvedRun) (Strategy, error) {
	kind := strings.ToLower(strings.TrimSpace(r.Strategy.Kind))
	...
	default:
		return nil, fmt.Errorf("unsupported strategy.kind %q", r.Strategy.Kind)
	}
}

func BuildEMACrossConfigFromRun(r ResolvedRun) (EMACrossConfig, error) {
...
func BuildEMACrossADXConfigFromRun(r ResolvedRun) (EMACrossADXConfig, error) {
...
func BuildTemplateStrategyConfigFromRun(r ResolvedRun) (TemplateStrategyConfig, error) {
